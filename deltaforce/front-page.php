    ...
    <div class="container">
        <div class="about-grid">
            ...
            <div class="about-image-wrapper fade-in-left">
                <img
                    src="https://templodochurrasco.com.br/wp-content/uploads/2026/04/Guilherme-santos-churrasqueira.png"
                    alt="Guilherme Santos — Churrasqueiro Gourmet no Rio de Janeiro"
                    class="about-photo"
                    style="width:100%; border-radius:20px; object-fit:cover; aspect-ratio:4/5;"
                />
...
?>
<section class="section" style="background: var(--color-bg-light);" aria-label="Blog — Dicas de churrasco">
    <div class="container">

        <div class="text-center" style="margin-bottom: 3.5rem;">
            <span class="section-label">Aprenda com quem entende</span>
            <h2 class="section-title">
                <span class="title-underline">Blog de Dicas</span> 🔥
            </h2>
            <p style="color: var(--color-gray-600); max-width: 550px; margin: 1.5rem auto 0; font-size: 1.0625rem;">
                Segredos, técnicas e curiosidades para você aproveitar (ou contratar) o churrasco perfeito.
            </p>
        </div>
            ...
            <?php while ( $recent_posts->have_posts() ) : $recent_posts->the_post(); ?>
                <article class="blog-card fade-in" aria-label="<?php the_title_attribute(); ?>">
                    <div class="blog-card-img-wrapper">
                        ...
                        if ( $cats ) : ?>
                            <a href="<?php echo esc_url( get_category_link( $cats[0]->term_id ) ); ?>" class="blog-card-category">
