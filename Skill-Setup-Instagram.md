...
1. **Três subpastas fixas** dentro de `Setup Instagram/`: `Carrossel`, `Feeds`, `Reels-Stories`. Nenhuma outra subpasta deve ser criada sem atualizar este documento.
...
5. **Sempre commitar e dar push** da pasta `Setup Instagram/` para o GitHub após adicionar ou atualizar conteúdo — as automações consomem os arquivos diretamente do repositório remoto.
