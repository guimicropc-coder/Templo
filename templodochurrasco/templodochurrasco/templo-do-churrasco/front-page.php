    ...
    <div class="container">
        <div class="about-grid">
            ...
            <div class="about-image-wrapper fade-in-left">
                <img
                    src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/guilherme-santos.png' ); ?>"
                    alt="Guilherme Santos, Churrasqueiro Gourmet do Templo do Churrasco, assando carnes na brasa no Rio de Janeiro"
                    class="about-image"
                    width="500"
                    loading="eager"
                />
